  ...
  methods: {
    ...
    getComment () {
      ...
      this.$axios({
        ...
        // console.log(result)
        // 在获取完数据之后将总数赋值给total
        this.page.total = result.data.total_count // 将总数复制
...
//         { id: 1, name: '望京', date: '2020年3月7日02:41:16' },
//         { id: 2, name: '西二旗', date: '2020年3月7日02:41:16' },
//         { id: 3, name: '中关村', date: '2020年3月7日02:41:16' },
//         { id: 4, name: '国贸', date: '2020年3月7日02:41:16' },
//         { id: 5, name: '丰台科技园', date: '2020年3月7日02:41:16' }
</script>
